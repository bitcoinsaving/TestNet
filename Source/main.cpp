...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        //  Coinbase(hash=12630d16a9, nTime=1522762538, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        ...
        const char* pszTimestamp = "Bitcoin Saving 2018 The best way to profit by holding bitcoin coins";
        CTransaction txNew;
        txNew.nTime = 1522762538;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1522762538;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1963948 : 1963948;
        ...
        assert(block.hashMerkleRoot == uint256("0x6d1a64506ca94ac7cfe9b9fe5d15aef340ebc23d83ff686dcb8d0fa0adfed91e"));
...
unsigned char pchMessageStart[4] = { 0xf1, 0x20, 0xf9, 0x83 };
